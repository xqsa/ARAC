...
DEFAULT_PROTOCOL = Path(__file__).with_name("independent_semantic_parity_protocol_v2.json")
MANIFEST_SCHEMA = "arac-independent-semantic-parity-pilot-manifest-v2"
RECEIPT_SCHEMA = "arac-independent-semantic-parity-pilot-receipt-v2"
SUMMARY_SCHEMA = "arac-independent-semantic-parity-pilot-summary-v2"
SOURCE_PATHS = (
    "experiments/historical_recovery/independent_semantic_parity_pilot.py",
    "experiments/historical_recovery/independent_semantic_parity_protocol_v2.json",
...
def load_protocol(path: Path = DEFAULT_PROTOCOL) -> dict[str, Any]:
    ...
    if protocol["schema_version"] != "arac-independent-action-semantic-parity-protocol-v2":
